...
Ssdp.prototype.createSocket = function createSocket(networkInterface) {
  var self = this;
  var socket = dgram.createSocket(networkInterface.family === 'IPv4' ?
                                  'udp4' : 'udp6');
  ...
  process.nextTick(function() {
    ...
    socket.address = networkInterface.address;
    socket.bind(self._sourcePort, networkInterface.address);
  });
